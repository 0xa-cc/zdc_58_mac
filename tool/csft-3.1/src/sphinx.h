...
/////////////////////////////////////////////////////////////////////////////
	...
	#define USE_PYTHON		1   /// enable python datasource support.
#else
...
#define CORESEEK_BANNER			"Coreseek Full Text Server 3.1\n Copyright (c) 2006-2008 coreseek.com\n"
...
public:
	...
	virtual int					    GetLocalBuffer( BYTE * sBuffer, int iLength, BYTE * sOBuffer) {
		memcpy ( sOBuffer, sBuffer, iLength);
		sOBuffer[iLength] = 0;
		return 0;
	}
	/// Chinese NBest Segment related
	virtual int						GetNBest() { return m_iBest;   }
	virtual void					SetNBest(int n) { m_iBest = n;  }
	virtual bool					IsSentenceEnd() {	return false; }
	virtual bool					IsKeyWord(BYTE * sBuffer, int iLength ) {  return false; }
	/// This used by highlight, the max weight is 100
	virtual int						GetWordWeight (BYTE * sBuffer, int iLength) const { return 100; }
	/// get next token
	virtual BYTE *					GetToken (int n = 0) = 0;
...
protected:
	...
	int								m_iBest;					///< the nbest result in the tokenizer
...
ISphTokenizer *			sphCreateUTF8ChineseTokenizer ( const char* dict_path , int nBest = 1, int debug_mode = 0);
/// create GBK tokenizer with Chinese Segment support
ISphTokenizer *			sphCreateGBKChineseTokenizer ( const char* dict_path , int nBest = 1,  int debug_mode = 0);
/////////////////////////////////////////////////////////////////////////////
// DICTIONARIES
/////////////////////////////////////////////////////////////////////////////
